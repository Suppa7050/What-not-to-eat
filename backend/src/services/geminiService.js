...
const analyzeImage = async (imageBuffer, mimeType, userProfileText = "") => {
  try {
    // Determine which model to use. gemini-1.5-flash is good for multimodal fast tasks,
    // gemini-1.5-pro is better for complex reasoning. Using pro as this is a complex analysis.
    ...
    const prompt = `Analyze this food ingredient list. ${userProfileText ? "Take into account the following user profile for personalized recommendations: " + userProfileText : ""}`;
